            ...
            if (!$resultado = $mysqli->query($query)) {
                ...
                if (!$resultado = $mysqli->query($query)) {
                    ...
                    $mail->msgHTML("<html>
                                    ...
                                    <body>
                                        <div id='apDiv3'>
                                            <h1>Su solicitud No. " . $idAveriaEnProceso . ", con numero de OT No. <a href='http://www.siavg.ga/GenerarOTPDF.php?idOrdenTrabajo=" . $idAveriaEnProceso . "' target='_blank'>" . $idEnProceso ."</a> se encuenta en proceso de ejecucion</h1>
                                        </div>								
                                    </body>
                                    </html>");
            ...
            if (!$resultado = $mysqli->query($query)) {
                ...
                if (!$resultado = $mysqli->query($query)) {
                    ...
                    $mail->msgHTML("<html>
                                    ...
                                    <body>
                                        <div id='apDiv3'>
                                            <h1>Se finalizo su solicitud No. " . $idAveriaCerrar . ", con numero de OT No. <a href='http://www.siavg.ga/GenerarOTPDF.php?idOrdenTrabajo=" . $idAveriaCerrar . "' target='_blank'>" . $idCerrar .".</a></h1>
                                        </div>								
                                    </body>
                                    </html>");
